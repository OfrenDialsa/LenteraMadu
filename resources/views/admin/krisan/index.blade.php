    ...
    <ol class="list-unstyled">
        ...
        <li class="media">
            <div class="d-flex align-items-center">
                ...
                <div class="media-body">
                <a href="{{ url('/krisan/' . $item->id . '/edit') }}" title="Edit pengurus"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Tanggapi</button></a>
                </div>
            </div>
        </li>
